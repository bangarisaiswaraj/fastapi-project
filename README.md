...
[![codecov](https://codecov.io/gh/bangarisaiswaraj/fastapi-project/branch/main/graph/badge.svg?token=fastapi-project_token_here)](https://codecov.io/gh/bangarisaiswaraj/fastapi-project)
[![CI](https://github.com/bangarisaiswaraj/fastapi-project/actions/workflows/main.yml/badge.svg)](https://github.com/bangarisaiswaraj/fastapi-project/actions/workflows/main.yml)

Awesome fastapi_project created by bangarisaiswaraj

## Install

from source
```bash
git clone https://github.com/bangarisaiswaraj/fastapi-project fastapi_project
cd fastapi_project
make install
```
